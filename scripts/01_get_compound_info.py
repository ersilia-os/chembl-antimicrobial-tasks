...
# Load tables
df1 = pd.read_csv("../config/chembl_activities/compound_structures.csv", low_memory=False)
df2 = pd.read_csv("../config/chembl_activities/molecule_dictionary.csv", low_memory=False)
