...
The script `06_calculate_ecfps.py` calculates ECFPs (radius 3, 2048 bits) for sanitized and standardized compounds (step 02) using RDKit, ommiting failed SMILES and storing results in H5 file format (`output/descriptors.h5`).
